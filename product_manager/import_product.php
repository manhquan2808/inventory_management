                            ...
                            <div class="card-body">
                                ...
                                <form method="POST">
                                    ...
                                    if (isset($_REQUEST['import_id'])) {
                                        ...
                                        mysqli_query($conn, "UPDATE `products` SET `status` = 'Đang chờ nhập ' WHERE `products`.`product_id` = '$import';");
                                        mysqli_query($conn, "INSERT INTO `products_detail` (`id`, `product_id`, `inventory_id`, `status`, `time`) VALUES (NULL, '$import', '5', 'Nhập kho', '$currentDateTime')");


                                    }

                                    $result = mysqli_query($conn, "SELECT * FROM `products` where status = 'Ít' or status = 'Có sẵn' ");
                                    ?>
