        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#"
                        aria-expanded="false"><i class="mdi me-2 mdi-store"></i><span class="hide-menu">Kho thành phẩm</span></a>
                    <ul>
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="import_product.php" aria-expanded="false"><i class="mdi me-2 mdi-import"></i><span
                            class="hide-menu">Nhập thành phẩm</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="export_product.php" aria-expanded="false"><i class="mdi me-2 mdi-export"></i><span
                            class="hide-menu">Xuất thành phẩm</span></a></li>
