        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="check.php" aria-expanded="false"><i
                            class="mdi me-2 mdi-calendar-multiple-check"></i><span class="hide-menu">Kiểm kê NVL</span></a>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="list_check.php" aria-expanded="false"><i
                            class="mdi me-2 mdi-format-list-bulleted"></i><span class="hide-menu">Danh sách kiểm kê</span></a>
                </li>
